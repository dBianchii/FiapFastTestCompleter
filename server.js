...
;(async function main() {
	...
	await login()
	const fastTestPage = "https://on.fiap.com.br/mod/conteudoshtml/view.php?id=308347&c=8847&sesskey=rZCqXsPkHw"
	...
	for (let i = 0; i < elements.length; i++) {
		...
		for (let j = 0; j < questionContainer.length; j++) {
			...
			if (answer === result) {
				await driver.executeScript(`document.querySelector('[data-answer-id="${dataAnswerId}"] .on-fast-test-question-box').click()`)
